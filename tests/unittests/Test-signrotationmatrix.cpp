...
#include <BSMPT/models/ClassPotentialRxSM.h> // for Class_RxSM
...
TEST_CASE("Checking sign convention of rotation matrix for C2HDM", "[signrotationmatrix]")
{
  ...
  while (std::getline(testData, line)) {
    ...
    HiggsRotNeutralFixed[0][2] = -modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h1, pos_psi1)*SinBeta + modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h1, pos_psi2)*CosBeta;

    HiggsRotNeutralFixed[1][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h2, pos_zeta1);
    HiggsRotNeutralFixed[1][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h2, pos_zeta2);
    HiggsRotNeutralFixed[1][2] = -modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h2, pos_psi1)*SinBeta + modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h2, pos_psi2)*CosBeta;

    HiggsRotNeutralFixed[2][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h3, pos_zeta1);
    HiggsRotNeutralFixed[2][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h3, pos_zeta2);
    HiggsRotNeutralFixed[2][2] = -modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h3, pos_psi1)*SinBeta + modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h3, pos_psi2)*CosBeta;
    ...
    HiggsRotFixed[0][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Gp, pos_rho1);
    HiggsRotFixed[0][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Gp, pos_rho2);
    HiggsRotFixed[1][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Hp, pos_rho1);
    HiggsRotFixed[1][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Hp, pos_rho2);
    ...
    HiggsRotFixed[0][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Gm, pos_eta1);
    HiggsRotFixed[0][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Gm, pos_eta2);
    HiggsRotFixed[1][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Hm, pos_eta1);
    HiggsRotFixed[1][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Hm, pos_eta2);
    ...
    auto G0Fixed = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_G0, pos_psi1)*CosBeta + modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_G0, pos_psi2)*SinBeta;

    Check(G0Fixed, 1.);
  }
}

TEST_CASE("Checking sign convention of rotation matrix for CP in the Dark", "[signrotationmatrix]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
  ...
  while (std::getline(testData, line)) {
    ...
    HiggsRotNeutralFixed[0][2] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h1, pos_rhoS);

    HiggsRotNeutralFixed[1][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h2, pos_zeta2);
    HiggsRotNeutralFixed[1][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h2, pos_psi2);
    HiggsRotNeutralFixed[1][2] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h2, pos_rhoS);

    HiggsRotNeutralFixed[2][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h3, pos_zeta2);
    HiggsRotNeutralFixed[2][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h3, pos_psi2);
    HiggsRotNeutralFixed[2][2] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h3, pos_rhoS);
    ...
    auto GpFixed = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Gp, pos_rho1);
    auto GmFixed = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Gm, pos_eta1);
    auto HpFixed = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Hp, pos_rho2);
    auto HmFixed = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Hm, pos_eta2);
    auto HSMFixed = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_HSM, pos_zeta1);
    auto G0Fixed = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_G0, pos_psi1);
...
TEST_CASE("Checking sign convention of rotation matrix for CxSM", "[signrotationmatrix]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
  ...
  while (std::getline(testData, line)) {
    ...
    HiggsRotNeutralFixed[0][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h1, pos_zeta1);
    HiggsRotNeutralFixed[0][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h1, pos_zeta2);
    HiggsRotNeutralFixed[0][2] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h1, pos_zeta3);

    HiggsRotNeutralFixed[1][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h2, pos_zeta1);
    HiggsRotNeutralFixed[1][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h2, pos_zeta2);
    HiggsRotNeutralFixed[1][2] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h2, pos_zeta3);

    HiggsRotNeutralFixed[2][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h3, pos_zeta1);
    HiggsRotNeutralFixed[2][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h3, pos_zeta2);
    HiggsRotNeutralFixed[2][2] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h3, pos_zeta3);
    ...
    auto GpFixed = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Gp, pos_i_Gp);
    auto GmFixed = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_Gm, pos_i_Gm);
    auto G0Fixed = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_G0, pos_i_G0);
...
TEST_CASE("Checking sign convention of rotation matrix for N2HDM", "[signrotationmatrix]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
  ...
  while (std::getline(testData, line)) {
    ...
    std::vector<std::vector<double>> HiggsRotFixed(2, std::vector<double>(2));
    HiggsRotFixed[0][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_G0, pos_psi1);
    HiggsRotFixed[0][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_G0, pos_psi2);
    HiggsRotFixed[1][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_A, pos_psi1);
    HiggsRotFixed[1][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_A, pos_psi2);
...
TEST_CASE("Checking sign convention of rotation matrix for R2HDM", "[signrotationmatrix]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
  ...
  while (std::getline(testData, line)) {
    ...
    HiggsRotNeutralFixed[1][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h, pos_zeta1);
    HiggsRotNeutralFixed[1][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h, pos_zeta2);
...
TEST_CASE("Checking sign convention of rotation matrix for RxSM", "[signrotationmatrix]")
{
  using namespace BSMPT;
  const auto SMConstants = GetSMConstants();
  std::shared_ptr<BSMPT::Class_Potential_Origin> modelPointer =
  ...
  std::ifstream testData(BASE_PATH "/tests/unittests/signrotationmatrix_data/rxsm_unittest_signrotationmatrix.tsv");
  ...
  while (std::getline(testData, line)) {
    ...
    double mH1, mH2;
    ss >> mH1 >> mH2;
    if (std::abs(mH1 - SMConstants.C_MassSMHiggs) < std::abs(mH2 - SMConstants.C_MassSMHiggs))
    ...
    auto modelSpecificPointer = std::static_pointer_cast<BSMPT::Models::Class_RxSM>(modelPointer);
    ...
    std::vector<std::vector<double>> HiggsRotNeutralFixed(n, std::vector<double>(n));
    HiggsRotNeutralFixed[0][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h, pos_zeta1);
    HiggsRotNeutralFixed[0][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_h, pos_zetaS);

    HiggsRotNeutralFixed[1][0] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_H, pos_zeta1);
    HiggsRotNeutralFixed[1][1] = modelPointer->get_HiggsRotationMatrixEnsuredConvention(pos_H, pos_zetaS);
    ...
    // Do not test the angles for RxSM, as a1, a2, a3 from the data input is potentially for a
    //   different mass ordering, as they are input values for ScannerS
    // for (std::size_t i = 0; i < numAngles; ++i)
    // {
    //   auto expected = rotation_matrix_angles[n*n + i];
