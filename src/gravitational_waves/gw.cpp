    ...
    const TransitionTemperature &which_transition_temp, double custom_transition_temp) // CB: added
{
  ...
  ss << "RstarTest     = " << RstarTEST << "\n";
  ss << "HstarTEST = " << HstarTEST << "\n";
  ...
  ss << "HRstarEstimateFalse = " << HRstarEstimateFalse << "\n";
  ss << "HRstarEstimateTrue  = " << HRstarEstimateTrue << "\n";
  ss << "RstarEstimateFalse  = " << RstarEstimateFalse << "\n";
  ss << "RstarEstimateTrue   = " << RstarEstimateTrue << "\n";
